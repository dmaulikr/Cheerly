...
+ (void)setNavBarAppeareance {
    ...
    [[UIBarButtonItem appearance] setBackgroundImage:[[UIImage imageNamed:@"nav_button_orange.png"] stretchableImageWithLeftCapWidth:3.0 topCapHeight:2.0] forState:UIControlStateNormal barMetrics:UIBarMetricsDefault];
    [[UIBarButtonItem appearance] setBackButtonBackgroundImage:[[UIImage imageNamed:@"nav_button_back_orange.png"] stretchableImageWithLeftCapWidth:14.0 topCapHeight:2.0] forState:UIControlStateNormal barMetrics:UIBarMetricsDefault];
